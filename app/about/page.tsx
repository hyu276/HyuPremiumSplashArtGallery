...
export default async function About(){
  ...
  return <><SiteHeader/><main>
    ...
    <div className="content-wrap">
      ...
      <section className="section-grid"><div className="section-label">03 / Nền tảng</div><div className="section-copy"><h2>Thiết kế để tiếp tục phát triển.</h2><p>Website được triển khai trên Vercel và đọc dữ liệu bộ sưu tập hiện tại từ Supabase. Kiến trúc này cho phép mở rộng thêm các khu vực biên tập như Tin tức và Bài viết mà không làm thay đổi quy trình quản lý thư viện cốt lõi.</p></div></section>
