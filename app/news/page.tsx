...
export const metadata:Metadata={title:'News',description:'News and updates from the HYU PREMIUM gaming splash art archive.',alternates:{canonical:'https://hyupremium.vercel.app/news/'}};
