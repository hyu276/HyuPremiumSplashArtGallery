...
export const metadata:Metadata={
  ...
  description:'Khám phá splash art HYU PREMIUM theo từng dòng trang phục với gallery tương tác.',
...
export default async function UniversesPage(){
  ...
  return <>
    ...
    <main className="taxonomy-page"><section className="hero taxonomy-hero" id="top"><div className="hero-kicker"><i></i> HYU PREMIUM / Universe catalogue</div><h1>Dòng trang phục<br/><em>đa vũ trụ.</em></h1><div className="hero-foot"><p>Khám phá các dòng trang phục qua gallery tương tác theo chuẩn thư viện HYU PREMIUM.</p><span>Cuộn xuống để khám phá ↓</span></div></section><TaxonomyGalleryClient mode="universes" groups={groups}/><section className="manifesto"><p className="eyebrow">HYU PREMIUM / UNIVERSES</p><h2>Mỗi bộ sưu tập có<br/>một dấu ấn <em>riêng.</em></h2><div className="manifesto-copy"><p>Gallery sử dụng cùng ngôn ngữ tương tác với thư viện nhân vật: card 16:9, hover, expand inline và derivative 1600px khi mở rộng.</p></div></section></main>
    <SiteFooter/>
  </>;
}
