...
export async function generateMetadata():Promise<Metadata>{return metadataForPath('/blog/',{title:'Blog',description:'Editorial notes from the HYU PREMIUM gaming splash art archive.',alternates:{canonical:'https://hyupremium.vercel.app/blog/'}})}
