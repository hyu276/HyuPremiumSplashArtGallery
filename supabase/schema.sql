...
-- It creates normalized catalogue tables, owner authorization, RLS, and a public artwork bucket.
...
grant select on public.categories, public.image_credits, public.ranks to anon;
grant select on public.artworks to anon;
grant select, insert, update, delete on public.categories, public.image_credits, public.ranks, public.artworks to authenticated;
